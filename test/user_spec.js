...
describe("User",function(){
	...
	describe("defaults",function(){
		...
		before(function(){
			user = new User({email:"prakash@gmail.com"});		
		});

		it("email is prakash@gmail.com",function(){
			user.email.should.equal("prakash@gmail.com");
		});
		it("has a authentication token",function(){
